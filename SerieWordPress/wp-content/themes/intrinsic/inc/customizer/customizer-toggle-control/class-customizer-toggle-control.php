...
class Intrinsic_Toggle_Control extends WP_Customize_Control {
	public $type = 'ios';
	...
	public function enqueue() {
		wp_enqueue_script( 'intrinsic-customizer-toggle-control', get_theme_file_uri( '/inc/customizer/customizer-toggle-control/js/customizer-toggle-control.js' ), array( 'jquery' ), rand(), true );
		wp_enqueue_style( 'intrinsic-pure-css-toggle-buttons', get_theme_file_uri( '/inc/customizer/customizer-toggle-control/css/pure-css-togle-buttons.css' ), array(), rand() );
		...
		';
		wp_add_inline_style( 'intrinsic-pure-css-toggle-buttons' , $css );
	}
