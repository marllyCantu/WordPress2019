...
class INTRINSIC_OCDI_PLUGIN {
	...
	public function old_php_admin_error_notice() {
		$message = sprintf( esc_html__( 'The %2$sDemo Import%3$s plugin requires %2$sPHP 5.3.2+%3$s to run properly. Please contact your hosting company and ask them to update the PHP version of your site to at least PHP 5.3.2.%4$s Your current version of PHP: %2$s%1$s%3$s', 'intrinsic' ), phpversion(), '<strong>', '</strong>', '<br>' );
...
$ocdi_plugin = new INTRINSIC_OCDI_PLUGIN();
