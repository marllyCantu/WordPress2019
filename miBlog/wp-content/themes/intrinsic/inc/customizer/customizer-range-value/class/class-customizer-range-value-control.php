 ...
 * @access public
 */
class Intrinsic_Customizer_Range_Value_Control extends WP_Customize_Control {
	...
	/**
	 * Intrinsic_Customizer_Range_Value_Control constructor.
	 *
 ...
 * @since 1.0
 */
function intrinsic_sanitize_range_value( $input ) {
	if ( intrinsicis_json( $input ) ) {
