wp.customize.controlConstructor['intrinsic-dimensions'] = wp.customize.Control.extend({
...
jQuery( document ).ready( function($) {
	...
	// Linked button
	$( '.intrinsic-linked' ).on( 'click', function() {
	...
	// Unlinked button
	$( '.intrinsic-unlinked' ).on( 'click', function() {
