...
/**
 * Class Intrinsic_Customize_Alpha_Color_Control
 */
class Intrinsic_Customize_Alpha_Color_Control extends WP_Customize_Control {
	/**
	...
	public function enqueue() {
		wp_enqueue_script( 'intrinsic-alpha-color-picker', get_theme_file_uri( '/inc/customizer/customizer-alpha-color-picker/js/alpha-color-picker.js' ), array( 'jquery', 'wp-color-picker' ), '1.0', true	);
		wp_enqueue_style( 'intrinsic-alpha-color-picker', get_theme_file_uri( '/inc/customizer/customizer-alpha-color-picker/css/alpha-color-picker.css' ), array( 'wp-color-picker' ),
			'1.0'	);
	}
	/**
	 * Render the control.
