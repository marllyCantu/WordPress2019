 ...
 * @since 1.0
 */
function intrinsicGetCss( arraySizes, settings, to ) {
    'use strict';
     var data, desktopVal,
 ...
 */
function intrinsicSetCss( settings, to ){
    'use strict';
    var result     = '';
 ...
 */
wp.customize(
    'intrinsic_options[body_font_size]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
                ...
                intrinsicGetCss( arraySizes, settings, to );
            }
        );
    }
);
wp.customize(
    'intrinsic_options[site_title_font_size]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
...
wp.customize(
    'intrinsic_options[menu_font_size]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
...
wp.customize(
    'intrinsic_options[post_blockquote_content]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
...
wp.customize(
    'intrinsic_options[post_title_content]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
...
wp.customize(
    'intrinsic_options[heading_one_content]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
...
wp.customize(
    'intrinsic_options[heading_two_content]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
...
wp.customize(
    'intrinsic_options[heading_three_content]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
...
wp.customize(
    'intrinsic_options[heading_four_content]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
...
wp.customize(
    'intrinsic_options[heading_five_content]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
...
wp.customize(
    'intrinsic_options[heading_six_content]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
...
wp.customize(
    'intrinsic_options[body_font_color]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
...
wp.customize(
    'intrinsic_options[heading_font_color]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
...
wp.customize(
    'intrinsic_options[site_title_color]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
...
wp.customize(
    'intrinsic_options[description_title_color]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
